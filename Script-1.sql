...
create table if not exists Compilations (id SERIAL primary key, name varchar(80) not null, post_year varchar(80), track_id INTEGER not null references Tracks(id));